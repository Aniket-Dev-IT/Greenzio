        ...
        <div class="row mb-5">
            <div class="col-lg-8">
                                ...
                                <div class="col-12 col-md-5">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="cart-title text-left">
                                            ...
                                            <br>
                                            <span class="text-muted text-sm"><?php echo $product['weight'] . ' ' . ucfirst($product['unit']); ?></span>
                                            <br>
                                            <?php if (!empty($product['brand'])): ?>
                                            <span class="text-muted text-sm">Brand: <?php echo $product['brand']; ?></span>
                                            <br>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12 col-md-7 mt-4 mt-md-0">
                                    <div class="row align-items-center">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-5 col-sm-3 col-md-12">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <button class="btn btn-sm btn-outline-secondary" onclick="updateQuantity(<?php echo $product['pid']; ?>, -1)">-</button>
                                                        <input type="number" value="<?php echo $product['quantity']; ?>" min="1" max="<?php echo $product['stock_quantity']; ?>" 
                                        ...
                                        <div class="col-2 d-none d-md-block text-center">
                                            <a href="<?php echo base_url().'shopping/deleteItem?id='.$product['pid'];?>" class="cart-remove">
                ...
                <div class="my-5 d-flex justify-content-between flex-column flex-lg-row">
                    ...
                    class="btn btn-outline-dark" id="proceedToCheckOut" onclick="return validateMinimumOrder()">Proceed to checkout
...
function updateQuantityDirect(pid, quantity) {
    ...
    .then(data => {
        if (data.success) {
            ...
            alert(data.message);
            // Reset to original quantity if update failed
            location.reload();
        }
    })
    .catch(error => {
...
function validateMinimumOrder() {
    // Get cart total from the order summary
    const orderSummaryElement = document.querySelector('.order-summary-total');
    if (!orderSummaryElement) {
        return true; // Allow if we can't find the total
    }
    
    const totalText = orderSummaryElement.textContent.replace(/[^\d.]/g, '');
    const cartTotal = parseFloat(totalText);
    const minimumOrderAmount = 200;
    
    if (cartTotal < minimumOrderAmount) {
        alert('Minimum order amount is ₹' + minimumOrderAmount + '. Please add ₹' + (minimumOrderAmount - cartTotal) + ' more to proceed.');
        return false;
    }
